...
/**
 * Service handles the queue that processes messages synchronously.
 */
class SynchronousQueueMessageListenerService implements MessageListener, ErrorHandler {

    private TestMessageSender messageSender;
    private static final Logger LOGGER = Logger.getLogger(SynchronousQueueMessageListenerService.class);
